...
// Each staff member is looked up live from Discord using their user ID —
// the site pulls their current Discord username + avatar automatically.
// tier controls where they render: "owner" | "management" | "support".
// role is the label shown under their name (can be anything you want).
export const STAFF = {
  owner: [
    { name: "KASSTOP", role: "Owner", icon: "crown" },
    { name: "The-Doctor", role: "Owner", icon: "crown" },
  ],
  management: [
    { name: "!LIL TYLER", role: "Supervisor", icon: "shield" },
    { name: "Karma", role: "Whitelist Manager", icon: "clipboard" },
    { name: "Jinx", role: "Whitelist Manager", icon: "clipboard" },
  ],
  support: [
    { name: "Moderator", role: "Support", icon: "headset" },
    { name: "Moderator", role: "Support", icon: "headset" },
    { name: "Support Agent", role: "Support", icon: "headset" },
    { name: "Support Agent", role: "Support", icon: "headset" },
  ],
};
