...
export const APPLY_URL = "https://delta-whitelist-review.vercel.app"; // swap later once whitelist moves in here

export const STORY = [
  "Delta City grew faster than anyone planned for. Three factions run the parts of it the city council doesn't talk about, the police force is stretched thin, and the skyline looks better at night than it does up close.",
  "Every player walks in with a name and a reason to keep their past quiet. What they build from there — a business, a badge, a record — is theirs to write. There's no fixed storyline here; the server's history is just the sum of what its players decided to do.",
];
...
export const PROPERTY = {
  business: ["Downtown Diner", "Delta Auto Shop", "The Lockbox Bar", "Riverside Garage"],
