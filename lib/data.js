...
export const STAFF = {
  ...
  pcChecker: [
    { name: "! DARK ヤ", role: "Pc Checker", icon: "monitor", photo: "/staff/dark.png" },
  ],
  support: [
...
// Streamers page — add one object per streamer.
// photo and platform are optional; url is the channel link.
export const STREAMERS = [
  { name: "C R A C K", photo: "/streamers/crack.jpg", platform: "Kick", url: "https://kick.com/cr1ack" },
];
